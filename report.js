function reportIntro() {
	...
	print(`<ul>
 	...
 	'<font color="blue">Стоимости</font> (<font color="blue">затраты</font>) <font color="blue">c<sub>ij</sub></font>. В этой таблице показана <font color="blue">стоимость</font><br>провоза по каждому из путей от ПО<sub>i</sub> до ПН<sub>j</sub>.' +
...
function reportMinPlan1(i, j) {
	...
	print('Какова наша главная цель? Прежде всего, мы хотим по максимуму сэкономить на доставке. Доставка за единицу груза между определенными ПО и ПН указана в таблице <font color="blue">c<sub>ij</sub></font>.')
